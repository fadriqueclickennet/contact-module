            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    {!! Form::open(['route' => 'public.contact.submit', 'method' => 'post']) !!}
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <input type="checkbox" name="box" id="box">{{ trans('core::core.contacto_aviso_legal') }} <a href="{{ URL::to('/punt-clinic/politica-privacidad-y-cookies') }}" class="font-weight-bold" style="color:black !important;">Política de privacidad y cookies</a> *
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
